<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fmrInicioEst.aspx.cs" Inherits="ColegioConvenio.Vistas.Estudiante.fmrInicioEst" %>
...
&nbsp;
        ...
        <h1>¿Bienvenido Estudiante que desea hacer?</h1>
        <div>
            <ul class="nav justify-content-center">
                <li class="nav-item"><a class="nav-link" href="fmrConsultarBitacoras.aspx">Consultar la bitacora</a></li>
                <li class="nav-item"><a class="nav-link" href="fmrConsultarHorario.aspx">Consultar el horario</a> </li>
