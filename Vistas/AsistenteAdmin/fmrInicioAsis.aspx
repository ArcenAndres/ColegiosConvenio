<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fmrInicioAsis.aspx.cs" Inherits="ColegioConvenio.Vistas.AsistenteAdmin.fmrInicioAsis" %>
<!DOCTYPE html>
...
&nbsp;
        ...
        <h1>¿Bienvenido asistente que desea hacer?</h1>
        <div>
            <ul class="nav justify-content-center">
                <li class="nav-item"><a class="nav-link" href="fmrCrearBitacora.aspx">Crear bitacora </a></li>
                <li class="nav-item"><a class="nav-link" href="fmrCrearDocente.aspx">Crear Docente</a> </li>
                <li class="nav-item"><a class="nav-link" href="fmrCrearEstudiante">Crear Estudiante</a> </li>
                <li class="nav-item"><a class="nav-link" href="fmrCrearHorario">Crear Horario</a> </li>
            </ul>
        </div>
